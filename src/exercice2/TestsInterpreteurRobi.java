 ...
 *
 * Comment utiliser : Lancer chaque test depuis main(). Observer la fenêtre et
 * la console. Chaque test affiche ce qui est attendu avant de s'exécuter.
 */
public class TestsInterpreteurRobi {
	...
	public static void test2_ConfigurationInverse() {
		...
		Exercice2_1_0 exo = new Exercice2_1_0("(space setColor white) (robi setColor blue)");
		exo.run();
	}
	...
	public static void test3_AnimationTranslate() {
		...
		Exercice2_1_0 exo = new Exercice2_1_0("(space setColor white) " + "(robi setColor red) "
				+ "(robi translate 10 0) (space sleep 300) " + "(robi translate 0 10) (space sleep 300) "
				+ "(robi translate -10 0) (space sleep 300) " + "(robi translate 0 -10)");
		exo.run();
	}
	...
	public static void test4_ScriptSujet() {
		...
		Exercice2_1_0 exo = new Exercice2_1_0("(space setColor white) " + "(robi setColor red) "
				+ "(robi translate 10 0) (space sleep 100) " + "(robi translate 0 10) (space sleep 100) "
				+ "(robi translate -10 0) (space sleep 100) " + "(robi translate 0 -10)");
		exo.run();
	}
	...
	public static void test5_GrandDeplacement() {
		...
		Exercice2_1_0 exo = new Exercice2_1_0("(space setColor black) " + "(robi setColor yellow) "
				+ "(robi translate 150 0) (space sleep 500) " + "(robi translate 0 60)");
		exo.run();
	}
	...
	public static void test6_CommandeInconnue() {
		...
		try {
			Exercice2_1_0 exo = new Exercice2_1_0("(robi commandeInexistante 10)");
			exo.run();
		} catch (Exception e) {
