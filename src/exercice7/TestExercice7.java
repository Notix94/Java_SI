 ...
 *
 * Teste les nouvelles fonctionnalités : - (set x valeur) : variables locales -
 * (loop n corps) : boucle N fois - (if condition v f) : conditionnelle - (+ - *
...
public class TestExercice7 {
	...
	public static void test1_VariableLocale() {
		...
		new Exercice7("(space add robi (Rect new)) " + "(set dist 50) " + "(robi translate dist 0)");
	}
	...
	public static void test2_BoucleSimple() {
		...
		new Exercice7("(space add robi (Rect new)) " + "(robi setColor red) " + "(set compteur 0) " + "(while (< compteur 10) "
				+ "    (robi translate 3 0) " + "    (set compteur (+ compteur 1)) " + "    (space sleep 20)" + ")");
	}
	...
	public static void test3_BoucleAvecVariable() {
		...
		new Exercice7("(space add robi (Rect new)) " + "(robi setColor blue) " + "(set n 15) " + "(set i 0) "
				+ "(while (< i n) " + "    (robi translate 0 2) " + "    (set i (+ i 1)) " + "    (space sleep 80)"
				+ ")");
	}
	...
	public static void test4_ConditionnelleVraie() {
		...
		new Exercice7("(space add robi (Rect new)) " + "(if (= 10 10) (robi setColor red) (robi setColor blue))");
	}
	...
	public static void test5_ConditionnelleFausse() {
		...
		new Exercice7("(space add robi (Rect new)) " + "(if (= 10 5) (robi setColor red) (robi setColor blue))");
	}
	...
	public static void test6_Arithmetique() {
		...
		new Exercice7("(space add robi (Rect new)) " + "(set a 5) " + "(set b 10) " + "(set total (+ a b)) "
	...
	public static void test7_CombinaisonComplexe() {
		...
		new Exercice7("(space add robi (Rect new)) " + "(robi setColor blue) " + "(set pas 0) " + "(set i 0) "
				+ "(while (< i 20) " + "    (robi translate 3 0) " + "    (set pas (+ pas 1)) "
				+ "    (if (> pas 10) (robi setColor red) (robi setColor blue)) " + "    (set i (+ i 1)) "
				+ "    (space sleep 100)" + ")");
	}
	...
	public static void test8_ModeInteractif() {
		...
		System.out.println("  > (while (< n 5) (robi translate 5 0) (space sleep 200))");
