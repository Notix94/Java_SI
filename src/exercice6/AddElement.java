...
public class AddElement implements Command {
	...
	public Reference run(Reference reference, SNode method, Environment env) {
		...
		// Enregistrement sous le nom composé : "space.robi"
		// On récupère le nom du conteneur depuis la s-expression
		String containerName = method.get(0).contents();
		env.addReference(containerName + "." + name, newElemRef);
		return newElemRef;
	}
}