...
public class ClientIHM extends JFrame {
    ...
    private void buildUI() {
        ...
        commandBox  = new JComboBox<>(new String[]{"translate", "setColor", "setPosition", "sleep", "save", "load", "screenshot"});
    ...
    private void updateArgsPanel() {
        ...
        if (cmd.equals("save") || cmd.equals("load")) {
            ...
            arg2.setVisible(false); argsPanel.getComponent(2).setVisible(false);
        } else if (cmd.equals("screenshot")) {
            arg1.setVisible(false); arg2.setVisible(false);
            argsPanel.getComponent(0).setVisible(false); argsPanel.getComponent(2).setVisible(false);
    ...
    private void buildAndSend() {
        ...
        if (cmd.equals("screenshot") || cmd.equals("save") || cmd.equals("load")) rec = "space";
    ...
    private void showScreenshot(String base64) {
        try {
            ...
            if (img != null) {
                JOptionPane.showMessageDialog(this, new JLabel(new ImageIcon(img)), "Capture Serveur", JOptionPane.PLAIN_MESSAGE);
            }
        } catch (Exception e) {
