 ...
 *
 * Même fonctionnalité que Ex2 mais avec l'architecture Command. Observer que le
 * résultat visuel est IDENTIQUE à Ex2.
 */
public class TestsCommandesRobi {
	...
	public static void test1_ConfigurationCouleurs() {
		...
		new Exercice3_0("(space setColor black) (robi setColor yellow)");
	...
	public static void test2_AnimationCompletesujet() {
		...
		new Exercice3_0("(space setColor black) " + "(robi setColor yellow) " + "(space sleep 1000) "
	...
	public static void test3_ArchitectureCommand() {
		...
		new Exercice3_0("(space setColor red) " + "(robi setColor green) " + "(robi translate 50 30)");
